...
dwh = DWH(timestamp, "U:\\Json_Files\\Project_Size", True)
...
hist_data = pd.read_excel(sys.argv[1])
dwh.insert_into_db(destination_table="[DWH].[masterdata].[Project_Size]",df_insert=hist_data,engine=dwh_engine,add_time_cols=False)
print("")
